...
def run_app_home() : 
    ...
    st.write('본 프로젝트의 데이터는 Kaggle https://www.kaggle.com/datasets/shariful07/student-mental-health 에서 공유한 Student Mental health - A STATISTICAL RESEARCH ON THE EFFECTS OF MENTAL HEALTH ON STUDENTS’ CGPA dataset입니다. 다양한 분석 활동이 가능한 항목으로 구성되어 있어서 이 데이터 셋을 선택하였습니다. ')
